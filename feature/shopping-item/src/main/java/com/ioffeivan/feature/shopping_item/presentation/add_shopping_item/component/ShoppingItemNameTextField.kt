...
fun ShoppingItemNameTextField(
    ...
    SlaTextField(
        ...
        onValueChange = onShoppingItemNameChange,
        modifier = modifier,
        label = {
            Text(
                text = stringResource(R.string.shopping_item_name),
                style = MaterialTheme.typography.bodyLarge,
            )
        },
        placeholder = {
            Text(
                text = stringResource(R.string.enter_shopping_item_name),
                style = MaterialTheme.typography.bodyLarge,
            )
        },
